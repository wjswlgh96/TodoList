...
public class BoardRequestDto {
    ...
    @Schema(description = "작성자 ID 입력 (필수, 예: 1)", example = "1")
    ...
    @Schema(description = "제목 입력 (필수, 최대 50자)", example = "제목입니다.")
    private String title;

    @NotBlank(message = "할일 내용은 필수 입력 사항입니다.")
    @Size(max = 200, message = "할일 내용은 최대 200자 이내로 입력해야 합니다.")
    @Schema(description = "할일 입력 (필수, 최대 200자)", example = "오늘의 할일을 적겠습니다.")
